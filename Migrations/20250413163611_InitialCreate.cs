        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuditionDate = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Auditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Auditions_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Auditions_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auditions_EventId",
                table: "Auditions",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_Auditions_ScheduleId",
                table: "Auditions",
                column: "ScheduleId");
